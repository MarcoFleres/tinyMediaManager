...
public class MovieCastPanel extends JPanel {
  ...
  public MovieCastPanel(MovieSelectionModel model) {
    ...
    setLayout(new FormLayout(new ColumnSpec[] { FormFactory.UNRELATED_GAP_COLSPEC, FormFactory.DEFAULT_COLSPEC, FormFactory.RELATED_GAP_COLSPEC,
        FormFactory.MIN_COLSPEC, FormFactory.RELATED_GAP_COLSPEC, ColumnSpec.decode("50dlu:grow"), FormFactory.RELATED_GAP_COLSPEC,
        ColumnSpec.decode("100dlu"), FormFactory.UNRELATED_GAP_COLSPEC, }, new RowSpec[] { FormFactory.RELATED_GAP_ROWSPEC,
        ...
        RowSpec.decode("50dlu:grow"), FormFactory.PARAGRAPH_GAP_ROWSPEC, RowSpec.decode("50dlu:grow(2)"), FormFactory.PARAGRAPH_GAP_ROWSPEC, }));
    ...
    tableProducer.getColumnModel().getColumn(0).setCellRenderer(new BorderCellRenderer());
    tableProducer.getColumnModel().getColumn(1).setCellRenderer(new BorderCellRenderer());
    int[] cols = {};
    JScrollPane scrollPaneMovieProducer = TmmTable.createJScrollPane(tableProducer, cols);
    ...
    tableActors.getColumnModel().getColumn(0).setCellRenderer(new BorderCellRenderer());
    tableActors.getColumnModel().getColumn(1).setCellRenderer(new BorderCellRenderer());
    JScrollPane scrollPaneMovieActors = TmmTable.createJScrollPane(tableActors, cols);
