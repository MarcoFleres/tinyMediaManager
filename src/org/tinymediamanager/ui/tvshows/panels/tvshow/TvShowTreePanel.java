...
public class TvShowTreePanel extends JPanel implements ITmmTabItem {
  ...
  public TvShowTreePanel(TvShowSelectionModel selectionModel) {
    ...
    setLayout(new FormLayout(new ColumnSpec[] { ColumnSpec.decode("10dlu"), ColumnSpec.decode("default:grow"), FormFactory.RELATED_GAP_COLSPEC,
        FormFactory.DEFAULT_COLSPEC, FormFactory.RELATED_GAP_COLSPEC, }, new RowSpec[] { FormFactory.DEFAULT_ROWSPEC,
        FormFactory.RELATED_GAP_ROWSPEC, RowSpec.decode("3px:grow"), FormFactory.DEFAULT_ROWSPEC, }));
  ...
  private JPanel buildHeader() {
    ...
    panelHeader.setLayout(new FormLayout(new ColumnSpec[] { FormFactory.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"),
        FormFactory.RELATED_GAP_COLSPEC, ColumnSpec.decode("center:31px"), ColumnSpec.decode("center:30px"),
        ColumnSpec.decode("center:" + TvShowTreeCellRenderer.COLUMN_WIDTH + "px"),
        ColumnSpec.decode("center:" + TvShowTreeCellRenderer.COLUMN_WIDTH + "px"),
        ColumnSpec.decode("center:" + TvShowTreeCellRenderer.COLUMN_WIDTH + "px") }, new RowSpec[] { FormFactory.DEFAULT_ROWSPEC, }));
