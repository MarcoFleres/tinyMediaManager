...
public class TvShowSeasonInformationPanel extends JPanel {
  ...
  public TvShowSeasonInformationPanel(TvShowSeasonSelectionModel tvShowSeasonSelectionModel) {
    ...
    lblPosterSize = new JLabel(BUNDLE.getString("mediafiletype.season_poster")); //$NON-NLS-1$
    ...
    panelRight.setLayout(new FormLayout(new ColumnSpec[] { FormFactory.RELATED_GAP_COLSPEC, FormFactory.DEFAULT_COLSPEC,
    ...
    scrollPaneEpisodes = TmmTable.createJScrollPane(tableEpisodes, new int[] {});
    panelRight.add(scrollPaneEpisodes, "2, 9, 3, 1, fill, fill");
    ...
    PropertyChangeListener propertyChangeListener = new PropertyChangeListener() {
      ...
      public void propertyChange(PropertyChangeEvent propertyChangeEvent) {
        ...
        if (source instanceof TvShowSeasonSelectionModel || ADDED_EPISODE.equals(property) || REMOVED_EPISODE.equals(property)) {
  ...
  private void setPoster(TvShowSeason season) {
    ...
    if (posterSize.width > 0 && posterSize.height > 0) {
      lblPosterSize.setText(BUNDLE.getString("mediafiletype.season_poster") + " - " + posterSize.width + "x" + posterSize.height); //$NON-NLS-1$
    }
    else {
      lblPosterSize.setText(BUNDLE.getString("mediafiletype.season_poster")); //$NON-NLS-1$
    }
  }
