...
public class MovieSetTreePanel extends JPanel implements ITmmTabItem {
  ...
  private JPanel buildHeader() {
    ...
    panelHeader.setLayout(new FormLayout(new ColumnSpec[] { ColumnSpec.decode("min:grow"), FormFactory.LABEL_COMPONENT_GAP_COLSPEC,
        ColumnSpec.decode("center:30px"), ColumnSpec.decode("center:" + MovieSetTreeCellRenderer.COLUMN_WIDTH + "px"),
