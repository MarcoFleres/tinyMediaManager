...
import static org.tinymediamanager.thirdparty.GraphicsUtilities.*;
...
/**
 * <p>
 * A shadow renderer generates a drop shadow for any given picture, respecting the transparency channel if present. The resulting picture contains the
 * shadow only and to create a drop shadow effect you will need to stack the original picture and the shadow generated by the renderer.
 * </p>
 * <h2>Shadow Properties</h2>
 * <p>
 * A shadow is defined by three properties:
 * <ul>
 * <li><i>size</i>: The size, in pixels, of the shadow. This property also defines the fuzziness.</li>
 ...
 * </ul>
 * You can set these properties using the provided mutators or the appropriate constructor. Here are two ways of creating a green shadow of size 10
 * and with an opacity of 50%:
 * 
 * <pre>
 ...
 * <p>
 * A shadow is generated as a <code>BufferedImage</code> from another <code>BufferedImage</code>. Once the renderer is set up, you must call
 ...
 * when you embed the renderer in a graphical component and give the API user the ability to access the renderer. By listening to properties changes,
...
public class ShadowRenderer {
   ...
   * </p>
   * <p>
   * When the property change event is fired, the old value and the new value are provided as <code>Integer</code> instances.
   * </p>
   */
   ...
   * </p>
   * <p>
   * When the property change event is fired, the old value and the new value are provided as <code>Float</code> instances.
   * </p>
   */
  ...
  /**
   * <p>
   * Add a PropertyChangeListener to the listener list. The listener is registered for all properties. The same listener object may be added more than
   ...
   * </p>
   * <p>
   * The opacity is comprised between 0.0f and 1.0f; 0.0f being fully transparent and 1.0f fully opaque. If you provide a value out of these
